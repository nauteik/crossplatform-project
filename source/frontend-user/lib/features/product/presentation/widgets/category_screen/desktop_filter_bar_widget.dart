              ...
              Container(
                ...
                child: DropdownButton<String>(
                  ...
                  items: [
                    ...
                    DropdownMenuItem(
                      value: 'price_asc',
                      child: Text('Giá tăng dần', style: TextStyle(color: sortBy == 'price_asc' ? Colors.blue : null)),
                    ),
                    DropdownMenuItem(
                      value: 'price_desc',
                      child: Text('Giá giảm dần', style: TextStyle(color: sortBy == 'price_desc' ? Colors.blue : null)),
                    ),
                    DropdownMenuItem(
                      value: 'name_asc',
